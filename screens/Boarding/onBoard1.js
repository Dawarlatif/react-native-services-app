...
import { OnBoardingIcon, OnboardingImage1 } from '../../assets'
   ...
   return (
      <SafeAreaView className="bg-white flex-1 relative">
         ...
         <View className=" items-center space-y-[12px] ">
            <Text className="font-Inter justify-center items-center text-[34px] text-center px-12">Professional home cleaning </Text>
