...
import { OnboardingImage3 } from '../../assets'
   ...
   return (
      <SafeAreaView className="bg-white flex-1 relative">
         ...
         <View className=" items-center space-y-[12px] ">
            <Text className="font-Inter justify-center items-center text-[34px] text-center px-12">Plumber & expert nearby you</Text>
         ...
         <TouchableOpacity className="w-full items-center mt-[60px]"
            onPress={() => navigation.navigate("login")}
         >
            <View className="rounded-xl w-[150px] py-[15px] bg-[#6759FF] justify-center items-center">
               <Text className="text-gray-200">Get Started</Text>
            </View>
         </TouchableOpacity>
